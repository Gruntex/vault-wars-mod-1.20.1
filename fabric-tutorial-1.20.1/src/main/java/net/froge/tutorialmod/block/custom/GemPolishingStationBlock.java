package net.froge.tutorialmod.block.custom;

import net.froge.tutorialmod.block.entity.GemPolishingStationBlockEntity;
...
public class GemPolishingStationBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public @Nullable <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.GEM_POLISHING_STATION_BLOCK_ENTITY,
