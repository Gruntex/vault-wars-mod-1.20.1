package net.froge.tutorialmod.block;

import net.fabricmc.fabric.api.item.v1.FabricItemSettings;
import net.fabricmc.fabric.api.object.builder.v1.block.FabricBlockSettings;
import net.froge.tutorialmod.TutorialMod;
import net.froge.tutorialmod.block.custom.GemPolishingStationBlock;
import net.froge.tutorialmod.block.custom.SoundBlock;
...
public class ModBlocks {
    ...
    public static final Block SOUND_BLOCK = registerBlock("sound_block",
            new SoundBlock(FabricBlockSettings.copyOf(Blocks.IRON_BLOCK).sounds(BlockSoundGroup.DECORATED_POT)));

    public static final Block GEM_POLISHING_STATION = registerBlock("gem_polishing_station",
            new GemPolishingStationBlock(FabricBlockSettings.copyOf(Blocks.POLISHED_ANDESITE).nonOpaque()));
